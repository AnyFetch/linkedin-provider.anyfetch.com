...
var redirectToService = function(callbackUrl, cb) {
  ...
  var redirectUrl = 'https://www.linkedin.com/uas/oauth2/authorization?response_type=code&client_id=' + config.linkedin.api + '&state=' + state + '&redirect_uri=' + config.providerUrl + '/init/callback';
